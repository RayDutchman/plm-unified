...
async def get_values_batch(
    ...
    if type not in ('part', 'component', 'assembly', 'document', 'configuration'):
        raise HTTPException(status_code=400, detail="type 必须为 part、component/assembly、document 或 configuration")
